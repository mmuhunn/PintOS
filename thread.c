...
/* ITISYIJY ITISYIJY ITISYIJY ITISYIJY ITISYIJY ITISYIJY */
bool
priority_check(struct list_elem *a, struct list_elem *b, void *option)
{
  (void) option;
...
thread_unblock (struct thread *t) 
{
  ...
  // list_push_back (&ready_list, &t->elem);      // ITISYIJY
  list_insert_ordered(&ready_list, &t->elem, priority_check, NULL); // ITISYIJY

  if (thread_current() != idle_thread)            // ITISYIJY
    if (t->priority > thread_current()->priority) // ITISYIJY
      thread_yield();                             // ITISYIJY
